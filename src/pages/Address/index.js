...
class Address extends Component {
    ...
    componentDidMount = async () => {
        try {
            ...
            const response = await api.get("/api/confinement/", { headers: {'x-access-token': null} });
    ...
    onRowClick = async (rowData) => {
        // const token = await getToken();
        const response = await api.get("/api/confinement/treatment/"+rowData[0], { headers: {'x-access-token': null} }); 
